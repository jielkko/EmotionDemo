...
public class EmotionGridAllAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    public static final String TAG = "EmotionGridAllAdapter";

    private Context mContext;
    private List<EmotionModel> mAppData;


    public EmotionGridAllAdapter(Context context, List<EmotionModel> data) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case 0:
                view = LayoutInflater.from(mContext).inflate(R.layout.item_grid_all_emotion_delete, parent, false);
                holder = new TitleViewHolder(view);
                break;
            case 1:
                view = LayoutInflater.from(mContext).inflate(R.layout.item_grid_all_emotion, parent, false);
