...
public class EmojiKeyboard {
    ...
    private CheckBox emojiPanelSwitchView;
    ...
    public EmojiKeyboard(Activity activity, EditText editText, View emojiPanelView, CheckBox emojiPanelSwitchView, View contentView) {
        init(activity, editText, emojiPanelView, emojiPanelSwitchView, contentView);
    }

    private void init(Activity activity, EditText editText, View emojiPanelView, CheckBox emojiPanelSwitchView, View contentView) {
        this.activity = activity;
        this.editText = editText;
        this.emojiPanelView = emojiPanelView;
        this.emojiPanelSwitchView = emojiPanelSwitchView;
        ...
        this.sharedPreferences = this.activity.getSharedPreferences(Panel_KEYBOARD, Context.MODE_PRIVATE);
    ...
    public void showEmojiPanel() {
        emojiPanelSwitchView.setChecked(true);
    ...
    public void hideEmojiPanel(boolean showSoftKeyboard) {
        emojiPanelSwitchView.setChecked(false);
        if (emojiPanelView.isShown()) {
